...
public class filter_HdfcBank {
	public static void main(String[] args) {
		...
		/*
		  How many number of customer available whose balance is less than 900 by using count&streams in java 8?
		 */
		long result1 = li.stream().filter(bank -> bank.getBalance()<900).count();
		System.out.println("Number of  names in less than 900 = "+result1);
